...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/noStaticElementInteractions: mouseDown handler delegates focus to input
    // biome-ignore lint/a11y/noNoninteractiveElementInteractions: mouseDown handler delegates focus to input
    <div
