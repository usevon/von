...
export default function PrivacyPolicyPage() {
  return (
    <LegalDocument lastUpdated="January 2, 2026" title="Privacy Policy">
      <p>
        USEVON LLC ("<strong>Von</strong>," "<strong>we</strong>," "
        <strong>us</strong>," or "<strong>our</strong>") respects your privacy
        ...
        when you interact with our websites, products, or services
        (collectively, the "<strong>Services</strong>").
      </p>

      <h2>Information We Collect</h2>
      <p>
        We collect information that you voluntarily provide when you interact
        with the Services, such as when you create an account, contact us, or
        use our webhook infrastructure. This may include:
      </p>
      <ul>
      ...
      <p>
        We also automatically collect technical information when you use the
        Services, including browser type, device information, IP address, and
        general usage data.
      </p>
      ...
      <p>
        ...
        as hosting, payment processing, or analytics) only to the extent
        necessary for them to perform those services. See our{" "}
        <a href="/subprocessors">Subprocessors</a> page for a complete list.
      </p>
      <p>
        Webhook payload data is retained according to your plan's retention
        period. You can delete your data at any time through the dashboard or by
        contacting us.
      </p>
      ...
      <p>
        ...
        information, including encryption in transit and at rest, regular
        security audits, and access controls. For more details, see our{" "}
      ...
      <p>
        ...
        Continued use of the Services after changes indicates acceptance of the
        updated policy.
      </p>
